  ...
  return (
    ...
    <div>
        ...
        <Flex  style={{marginTop:"25px"}}>
           ...
           <SelectForm options={academicFacultyOptions} name="academicFaculty" disabled={isacademicFacultyLoading} label="Academic Faculty" suffixIcon={<IoIosArrowDown style={{fontSize:"20px", color:'#000'}}/>}></SelectForm>
           <SelectForm options={academicDepartmentOptions} name="academicDepartment" disabled={isacademicDepartmentLoading} label="Accademic Department" suffixIcon={<IoIosArrowDown style={{fontSize:"20px", color:'#000'}}/>}></SelectForm>
           <SelectFormWithWatch options={courseOptions} name="course" label="Course" disabled={iscourseLoading} onValueChange={setCourseId} suffixIcon={<IoIosArrowDown style={{fontSize:"20px", color:'#000'}}/>}></SelectFormWithWatch>
            {/* {
              ...
              <p style={{color:"red"}}>No faculty assigned , please assigned first</p>:undefined
            } */}

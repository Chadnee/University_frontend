...
} from "../../../features/admin/courseManagementApi";
import {
  weekDaysOptions,
  type TError,
  type TOption,
...
const CreateOfferedCourse = () => {
  ...
  const facultyPlaceholder = !courseId
    ? "Select course first ..."
    : isFacultyFetching
      ? "Loading faculties ..."
      : !facultyOptions?.length
        ? "No faculty assigned, please assign first ..."
        : "Select a Faculty ...";
      ...
      <Flex style={{ marginTop: "25px" }}>
        <AdmitForm onSubmit={onSubmit}>
          <SelectForm
            ...
            disabled={isRegisteredSemesterLoading}
          ...
          <SelectForm
            ...
            fixedValue={academicFacultyOption?.value}
            disabled
            options={academicFacultyOption ? [academicFacultyOption] : []}
            placeholder={
              !academicFacultyOption
                ? "Select department first (auto select)..."
                : ""
            }
          />
          ...
          <SelectForm
            ...
            required
            disabled={!courseId || isFacultyFetching || !facultyOptions}
            name="faculty"
            label="Faculty"
          ...
          <InputForm
            ...
            type="text"
            placeholder="Provide maximum capacity ..."
          />
          <InputForm
            name="section"
            label="Section"
            type="text"
            placeholder="Provide a section ..."
          />
          <SelectForm
            ...
            label="Days"
            suffixIcon={
              <CiCalendarDate style={{ fontSize: "20px", color: "#000" }} />
            }

...
const CreateCourse = () => {
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    ...
    const courseData = {
      ...
      preRequisiteCourses: prerequisit
        ? prerequisit?.map((item: TPreRequisiteCourse) => ({
            course: item,
            isDeleted: false,
          }))
        : [],
      ...
      <Flex style={{ marginTop: "25px" }}>
        <AdmitForm onSubmit={onSubmit}>
          ...
          <InputForm
            ...
            name="prefix"
            label="Course Prefix"
            placeholder="Provide a prefix ..."
          />
          <InputForm
            type="text"
            name="code"
            label="Course Code"
            placeholder="Provide a code ..."
          />
          <InputForm
            type="text"
            name="credits"
            label="Credits"
            placeholder="Provide a credit ..."
          />
          <SelectForm
